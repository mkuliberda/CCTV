...
#TODO: guard all move/remove with try, FIleNotFoundError exceptions
    ...
    with FaceExtractor.FaceImageExtractorProcess(file_selector=h264_selector, haar_cascade_settings_file="haarcascade_frontalface_default.xml", move_to_path="../camera/analyzed/", file_converter=video_converter_mp4) as face_extractor_process, \
        ...
        FileDeleter.FileDeleterThreaded(file_type="h264", files_limit=20, path="../camera/analyzed/") as h264_cleaner, \
        FileDeleter.FileDeleterThreaded(file_type="mp4", files_limit=20, path="../camera/") as mp4_cleaner, \
